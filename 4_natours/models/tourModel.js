...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10, // e.g 4.66666, 46.66666, 47, 4.7
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
...
// 2dsphere index cuz the data describes real points on the earth
...
//this embedding only works for creating new docs but not updates
